    ...
    >
      ...
      <div className="home-page">
        <div className='home-page-texts'>
          ...
          <Link to = "/headphones/xx99-mark-two-headphones"><Button  bgColor="#D87D4A;" pdng="15px 30px">See Products</Button></Link>
        </div>
      </div>
      <div>
        <CategoriesCards/>
      ...
      <div className='products-container'>
        <div className='first-product'>
          ...
          <Link to={"/speaker/zx9-speaker"}><Button pdng='15px 25px'>See Product</Button></Link>
        </div>
